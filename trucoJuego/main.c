...
int main(int argc, char *argv[]) {
	...
	//defino cuantos palos y que cantidad de carta son del mismo palo
	char paloCart[4][9] = {"Espada", "Oro", "Basto", "Copa"}; //Es un arreglo de 4 cadenas de caracteres, donde cada cadena puede tener hasta 9 caracteres mas el caracter nulo 0 
